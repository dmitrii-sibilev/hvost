...
class webrex_telegramwebinar extends CModule
{
  const MODULE_ID = 'webrex.telegramwebinar';
  ...
  function __construct()
  {
    ...
    $this->MODULE_NAME = Loc::getMessage('WEBREX_TELEGRAM_WEBINAR_MODULE_NAME');
    $this->MODULE_DESCRIPTION = Loc::getMessage('WEBREX_TELEGRAM_WEBINAR_MODULE_DESCRIPTION');

    $this->PARTNER_NAME = Loc::getMessage('WEBREX_TELEGRAM_WEBINAR_PARTNER_NAME');
    $this->PARTNER_URI = Loc::getMessage('WEBREX_TELEGRAM_WEBINAR_PARTNER_URI');
  }
