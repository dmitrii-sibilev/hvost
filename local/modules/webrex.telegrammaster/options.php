...
$moduleId = 'webrex.telegrammaster';
...
$tabs = [
    [
        'DIV' => 'settings',
        'TAB' => Loc::getMessage('WEBREX_TELEGRAM_MASTER_TAB_SETTINGS_NAME'),
        'TITLE' => Loc::getMessage('WEBREX_TELEGRAM_MASTER_TAB_SETTINGS_NAME')
    ],
];
$options = [
    'settings' => [
        [
            'BOT_TOKEN',
            Loc::getMessage('WEBREX_TELEGRAM_MASTER_BOT_TOKEN'),
            '',
            ['text', '']
        ],
        [
            'WEBHOOK_SECRET_TOKEN',
            Loc::getMessage('WEBREX_TELEGRAM_MASTER_WEBHOOK_SECRET_TOKEN'),
            '',
            ['text', '']
        ],
    ],
