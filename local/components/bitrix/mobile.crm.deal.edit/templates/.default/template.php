...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'COMPONENT_NAME' => 'crm.deal.show'
	),
	$component,
	array('HIDE_ICONS' => 'Y')
);
if ($arResult["CASHBACK_MESSAGE"]) {
echo '<div style="text-align: center; border: 1px solid red; padding: 0 5px; margin: 0 5px;">' . $arResult["CASHBACK_MESSAGE"] . '</div>';
}
if ($arResult["CONTACT_COMMENTS"]) {
//echo '<div style="text-align: center; border: 1px solid cadetblue; padding: 0 5px; margin: 10px 5px 0 5px;">' . $arResult["CONTACT_COMMENTS"] . '</div>';
}
